...
async def main():
    ...
    if plan:
        ...
        with open(f"chapter_plan_{start_chapter}_{end_chapter}.json", "w", encoding="utf-8") as f:
            f.write(plan)

        print(f"Chapter plan for Chapters {start_chapter}-{end_chapter} has been generated and saved.")
    else:
